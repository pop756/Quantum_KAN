...
class CrossResonanceHamiltonian_x_amp_sweep(BaseExperiment):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.set_experiment_options(amps=amps, **kwargs)
...
class EchoedCrossResonanceHamiltonian(CrossResonanceHamiltonian_x_amp_sweep):
